			...
			<Card>
				<CardHeader>
					...
					<div className="card-actions">
						<a href="https://zenoamaro.github.io/react-quill/" target="_blank" rel="noopener noreferrer">
							docs
						</a>
					</div>
				</CardHeader>
