    ...
    render() {
        return (
            <div className="animated fadeIn">
                <Card id="new47">
                    <CardHeader>
                        <i className="fa fa-font-awesome" /> 55 New Icons in 4.7
                    </CardHeader>
                    <CardBody>
                        <Row className="text-center">
                            ...
                            <Col xs="6" sm="4" md="3" lg="2">
                                ...
                                <br />drivers-license <span className="text-muted">(alias)</span>
                            </Col>
                            <Col xs="6" sm="4" md="3" lg="2">
                                <i className="fa fa-drivers-license-o fa-lg mt-4" />
                                <br />drivers-license-o <span className="text-muted">(alias)</span>
                            </Col>
                            <Col xs="6" sm="4" md="3" lg="2">
                            ...
                            <Col xs="6" sm="4" md="3" lg="2">
                                ...
                                <br />times-rectangle <span className="text-muted">(alias)</span>
                            </Col>
                            <Col xs="6" sm="4" md="3" lg="2">
                                <i className="fa fa-times-rectangle-o fa-lg mt-4" />
                                <br />times-rectangle-o <span className="text-muted">(alias)</span>
                            </Col>
                            <Col xs="6" sm="4" md="3" lg="2">
                    ...
                    <CardBody>
                        <Row className="text-center">
                            ...
                            <Col xs="6" sm="4" md="3" lg="2">
                                ...
                                <br />star-half-empty <span className="text-muted">(alias)</span>
                            </Col>
                    ...
                    <CardBody>
                        ...
                        <Row className="text-center">
                            ...
                            <Col xs="6" sm="4" md="3" lg="2">
                                ...
                                <br />y-combinator-square <span className="text-muted">(alias)</span>
                            </Col>
