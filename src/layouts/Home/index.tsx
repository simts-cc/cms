...
const makeSocialBoxData = (dataSetNo: number) => {
...
const makeSparkLineData = (dataSetNo: number, variant?: string) => {
...
class Home extends PureComponent<InjectedIntlProps, IState> {
	...
	onRadioBtnClick(radioSelected: number): void {
		this.setState({
	...
	render() {
		const { intl } = this.props,
			...
			action = intl.formatMessage({ id: 'Action' })
							...
							<CardBody>
								<Row>
									<Col sm="5">
										...
										<div className="small text-muted">2019/01</div>
									</Col>
									<Col sm="7" className="d-none d-sm-inline-block">
										<Button color="primary" className="float-right">
											<i className="icon-cloud-download" />
										</Button>
										<ButtonToolbar className="float-right" aria-label="Toolbar with ButtonGroups">
										...
										<tr>
											<td className="text-center">
												<div className="avatar">
													<img
														src={'https://git.simts.cc/avatars/916e71394695730f43913674642cbd5d'}
											...
											<td>
												<div className="clearfix">
													...
													<div className="float-right">
														<small className="text-muted">2018/12 - 2019/01</small>
													</div>
												</div>
