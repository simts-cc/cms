...
class BasicForms extends PureComponent<{}, IState> {
						...
						<Card>
							<CardHeader>
								...
								<div className="card-actions">
									...
									<Button className="btn btn-minimize" data-target="#collapseExample" onClick={this.toggle}>
								...
								<CardBody>
									<Form className="form-horizontal">
										<FormGroup>
											...
											<div className="controls">
												<InputGroup className="input-prepend">
													...
													<Input id="prependedInput" bsSize="lg" type="text" />
												</InputGroup>
										...
										<FormGroup>
											...
											<div className="controls">
												<InputGroup>
													<Input id="appendedInput" bsSize="lg" type="text" />
													<div className="input-group-append">
														<span className="input-group-text">.00</span>
													</div>
												</InputGroup>
										...
										<FormGroup>
											...
											<div className="controls">
												<InputGroup className="input-prepend">
													...
													<Input id="appendedPrependedInput" bsSize="lg" type="text" />
													<div className="input-group-append">
														<span className="input-group-text">.00</span>
													</div>
												</InputGroup>
										...
										<FormGroup>
											...
											<div className="controls">
												<InputGroup>
													<Input id="appendedInputButton" bsSize="lg" type="text" />
													<div className="input-group-append">
										...
										<FormGroup>
											...
											<div className="controls">
												<InputGroup>
													<Input id="appendedInputButtons" bsSize="lg" type="text" />
													<div className="input-group-append">
