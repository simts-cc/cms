...
interface IState {
	...
	expContract: boolean
	expOverlay: boolean
	expSlideLeft: boolean
	expSlideRight: boolean
	expSlideUp: boolean
	expSlideDown: boolean
	expZoomIn: boolean
	expZoomOut: boolean
	progress?: number
}

class LoadingButtons extends PureComponent<{}, IState> {
		...
		return (
			<div className="animated fadeIn">
				<Row>
					<Card>
						<CardHeader>
							<i className="icon-cursor" /> LoadingButtons - React Ladda
						</CardHeader>
						<CardBody>
							<p>
								A UI concept which merges loading indicators into the action that invoked them. Primarily intended for use with forms
								where it gives users immediate feedback upon submit rather than leaving them wondering while the browser does its
								thing. For a real-world example, check out any of the forms on <a href="http://slides.com">slides.com</a>.
							</p>
