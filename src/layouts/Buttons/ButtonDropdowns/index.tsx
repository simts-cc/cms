...
import { Row, Col, Card, CardHeader, CardBody, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem, Button } from 'reactstrap'

interface IState {
	dropdownOpen: boolean[]
}

class ButtonDropdowns extends PureComponent<{}, IState> {
				...
				<Row>
					<Col xs="12">
						<Card>
							<CardHeader>
								...
								<div className="card-actions">
									<a href="https://reactstrap.github.io/components/button-dropdown/" target="_blank" rel="noopener noreferrer">
						...
						<Card>
							<CardHeader>
								<i className="fa fa-align-justify" />
								<strong>Single ButtonDropdowns</strong>
							</CardHeader>
							<CardBody>
								<ButtonDropdown
									className="mr-1"
						...
						<Card>
							<CardHeader>
								<i className="fa fa-align-justify" />
								<strong>Split ButtonDropdowns</strong>
							</CardHeader>
							<CardBody>
								<ButtonDropdown
									className="mr-1"
						...
						<Card>
							<CardHeader>
								<i className="fa fa-align-justify" />
								<strong>Button Dropup variation</strong>
							</CardHeader>
							<CardBody>
								<ButtonDropdown
									direction="up"
