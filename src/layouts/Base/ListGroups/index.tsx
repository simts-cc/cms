...
import { Row, Col, Card, CardHeader, CardBody, ListGroup, ListGroupItem, ListGroupItemHeading, ListGroupItemText, Badge } from 'reactstrap'

class ListGroups extends PureComponent {
	render() {
		return (
						...
						<Card>
							<CardHeader>
								...
								<div className="card-actions">
									<a href="https://reactstrap.github.io/components/listgroup/" target="_blank" rel="noopener noreferrer">
