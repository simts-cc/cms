...
class Navbars extends PureComponent<{}, IState> {
				...
				<Card>
					<CardHeader>
						...
						<div className="card-actions">
							<a href="https://reactstrap.github.io/components/navbar/" target="_blank" rel="noopener noreferrer">
						...
						<Navbar color="info" light expand="md">
							...
							<Collapse isOpen={this.state.isOpen} navbar>
								<Nav className="ml-auto" navbar>
									...
									<NavItem>
										<NavLink href="https://github.com/reactstrap/reactstrap" target="_blank" rel="noopener noreferrer">
											Github
										</NavLink>
									</NavItem>
