	...
	render() {
		return (
			<div className="animated">
				<Card>
					<CardHeader>
						<i className="fa fa-spinner" /> Spinners - SpinKit
					...
					<CardBody>
						<p>
							Simple loading spinners animated with CSS. SpinKit uses hardware accelerated (translate and opacity) CSS animations to
